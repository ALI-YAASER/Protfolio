...
//     return (
//         <nav
//             className={`w-full fixed top-0 left-0 z-50 px-6 lg:px-12 py-4 flex items-center justify-between transition-all duration-300 ${
...
//                 {/* Contact Button (Static in All Screens) */}
//                 <Link
...
//                 <div
//                     ref={sideMenuRef}
//                     className={`absolute right-0 top-0 bottom-0 w-64 bg-white shadow-lg z-50 transition-transform duration-300 flex flex-col ${
...
const Navbar = () => {
  ...
  >
    ...
    />
              ...
              {/* Mobile Menu + Overlay */}
            <div
                className={`fixed inset-0 z-40  flex items-center justify-between transition-opacity duration-300 ${
                    isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
                }`}
            >
                {/* Overlay */}
